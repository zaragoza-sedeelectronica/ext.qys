                ...
                $scope.lanzarModalAccion = function() {
                    ...
                    var modalInstance = $uibModal.open({
                        ...
                        controller: function($scope, $uibModalInstance, regInterno, accionesBase, entidadExterna, entidadInterna, estados_internos, permisos, selectedIds) {
                            ...
                            $scope.linkOt = CryptoJS.HmacSHA1("preview-orden-trabajo#" + clientID + "#"+ datosUsuario.propiedades.rootcat_ticketing, secretKey, {asBytes: true}).toString();
                    ...
                    $scope.lanzarModalBusqueda = function() {
                        ...
                        var modalInstance = $uibModal.open({
                            ...
                            controller: function($scope, $uibModalInstance, types, estados, origin, entidadExterna, entidadInterna, estados_internos, permisos, categories) {
                            	...
                            	$scope.linkExcel = CryptoJS.HmacSHA1("excel#" + clientID + "#"+ datosUsuario.propiedades.rootcat_ticketing, secretKey, {asBytes: true}).toString();
                            	$scope.linkCsv = CryptoJS.HmacSHA1("csv#" + clientID + "#"+ datosUsuario.propiedades.rootcat_ticketing, secretKey, {asBytes: true}).toString();
                            	$scope.linkAvisosCsv = CryptoJS.HmacSHA1("avisoscsv#" + clientID + "#"+ datosUsuario.propiedades.rootcat_ticketing, secretKey, {asBytes: true}).toString();
