var app = angular.module('app', [
    ...
    function($routeProvider, $locationProvider, RestangularProvider, $httpProvider, uiSelectConfig) {
        ...
        $routeProvider.
        when('/', {
            templateUrl: '/cont/vistas/servicio/planes/admin/plan/partials/plan-list.html',
            controller: 'ListCtrl'
        }).
        when('/edit/:id', {
            templateUrl: '/cont/vistas/servicio/planes/admin/plan/partials/plan-details.html',
            controller: 'EditCtrl',
            resolve: {
        ...
        RestangularProvider.setBaseUrl('/sede/servicio/planes/admin');
