var app = angular.module('app', [
    ...
    function($routeProvider, $locationProvider, RestangularProvider, $httpProvider, uiSelectConfig) {
        ...
        $routeProvider.
        when('/', {
            templateUrl: '/cont/vistas/servicio/cultura/evento/admin/tema/partials/tema-list.html',
            controller: 'ListCtrl'
        }).
        when('/edit/:id', {
            templateUrl: '/cont/vistas/servicio/cultura/evento/admin/tema/partials/tema-details.html',
            controller: 'EditCtrl',
            resolve: {
                registro: function(Dao, $route) {
                    return Dao.detalle('tema');
                }
            }
        }).
        when('/new', {
...
// .
// factory('RestangularSubtema', function(Restangular) {
