...
.controller('EditCtrl', ['$scope', 'Dao', '$http', 'registro', 'Restangular','$location', '$route', 'Informer', '$filter', '$window', '$timeout', 
	...
	if (registro.promedioPersonasVehiculo != null) {
		$scope.registro.promedioPersonasVehiculo = parseFloat(registro.promedioPersonasVehiculo);
	}
	    ...
	    entity.promedioPersonasVehiculo = parseFloat(entity.promedioPersonasVehiculo);
            // Realizar petición
            if($location.path() === '/new') {
