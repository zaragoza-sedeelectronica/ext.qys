    ...
    function($scope, $location, Dao, Informer, Restangular) {
        ...
        $scope.guardar = function() {
            Dao.crear('dataset', $scope.registro).then(function(res) {
                ...
                if(registro.geo=='S') {
	                Restangular.one('dataset/geonetwork/' + registro.id).get({operation: "Insert"}).then(function(res) {
	                 	console.log('ok:' + res.toString());
	                 	Informer.inform("Registro guardado correctamente en geonetwork", "info");
	                 }, function(err) {
	                	 Informer.inform("Se ha producido un error al guardar el registro en geonetwork.", "danger");
	                     console.log(err);
	                 });
                }
...
//            		});
        ...
        $scope.guardar = function() {
            Dao.actualizar($scope.registro).then(function(res) {
                ...
                if(registro.geo=='S') {
	                Restangular.one('dataset/geonetwork/' + registro.id).get({operation: "Update"}).then(function(res) {
	                 	console.log('ok:' + res.toString());
	                 	Informer.inform("Registro guardado correctamente en geonetwork", "info");
	                 }, function(err) {
	                	 Informer.inform("Se ha producido un error al guardar el registro.", "danger");
