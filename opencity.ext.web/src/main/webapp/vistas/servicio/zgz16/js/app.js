var app = angular.module('app', [
    ...
    function($routeProvider, $locationProvider, RestangularProvider, $httpProvider, uiSelectConfig) {
        ...
        $routeProvider.
        when('/', {
            templateUrl: '/cont/vistas/servicio/zgz16/partials/bloque-user.html',
            controller: 'UserCtrl'
        }).
        when('/list', {
            templateUrl: '/cont/vistas/servicio/zgz16/partials/bloque-list.html',
            controller: 'ListCtrl'
        }).
        when('/edit/:id', {
            templateUrl: '/cont/vistas/servicio/zgz16/partials/bloque-details.html',
            controller: 'EditCtrl',
            resolve: {
                registro: function(Dao, $route) {
                    return Dao.detalle('zgz16');
                }
            }
        }).
        when('/new', {
