var app = angular.module('app', [
    ...
    function($routeProvider, $locationProvider, RestangularProvider, $httpProvider, uiSelectConfig) {
        ...
        $routeProvider.
        when('/', {
            templateUrl: '/cont/vistas/servicio/aviso/admin/partials/aviso-list.html',
            controller: 'ListCtrl'
        }).
        when('/edit/:id', {
            templateUrl: '/cont/vistas/servicio/aviso/admin/partials/aviso-details.html',
            controller: 'EditCtrl',
            resolve: {
                registro: function(Dao, $route) {
                    return Dao.detalle('aviso/admin');
                }
            }
        }).
        when('/new', {
        ...
        when('/location', {
            ...
            templateUrl: '/cont/vistas/servicio/aviso/admin/partials/location.html'
        }).
        otherwise({
            redirectTo: '/'
        });
