var app = angular.module('app', [
    ...
    function($routeProvider, $locationProvider, RestangularProvider, $httpProvider, uiSelectConfig) {
        ...
        $routeProvider.
        when('/', {
            templateUrl: '/cont/vistas/servicio/licencia-obra/admin/partials/parcela-list.html',
            controller: 'ListCtrl'
        }).
        when('/edit/:id', {
            templateUrl: '/cont/vistas/servicio/licencia-obra/admin/partials/parcela-details.html',
            controller: 'EditCtrl',
            resolve: {
                registro: function(Dao, $route) {
                    return Dao.detalle('licencia-obra');
                }
            }
        }).
        when('/new', {
